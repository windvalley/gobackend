// Code generated by "codegen -type=int /Users/xg/github/gobackend/internal/pkg/code"; DO NOT EDIT.

package code

// init register error codes defines in this source code to `pkg/errors`
func init() {
	...
	register(ErrFieldSelectorValidation, 400, "Field selector validation failed")
	register(ErrUpdateNone, 400, "Update nothing")
